...
# 매번 나가면 비매너 점수가 쌓이므로, 0:2 판을 따로 세고 그중 40%만 나갑니다
# (20판이면 8판). 판정 규칙은 macroapp/auto_exit.py(순수 로직)에 있습니다.
AUTO_EXIT_ENABLED = True
#: (내 점수, 상대 점수). 내 팀은 왼쪽입니다(감독모드 화면 규칙).
AUTO_EXIT_LOSING_SCORE = (0, 2)
