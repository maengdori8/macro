...
[Setup]
; ⚠️ AppId 는 일반(Macro)·mPause 와 반드시 달라야 한다. 같으면 서로의 설치를
...
OutputDir=dist
OutputBaseFilename=macro_pro_setup
Compression=lzma2
SolidCompression=yes
UninstallDisplayIcon={app}\launcher_pro.exe
...
;  일으켜, 폴더형으로 전환함. dist\macro_pro_app\ 안의 모든 파일을 재귀로 담는다.)
...
Source: "dist\macro_pro_app\*"; DestDir: "{app}"; Excludes: "license.key,logs\*,_update_tmp\*,_update.zip,startup_error.log,vgamepad\win\vigem\install\*"; Flags: ignoreversion recursesubdirs createallsubdirs
Source: "dist\launcher_pro.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "version.txt"; DestDir: "{app}"; Flags: ignoreversion
; 설치 중에만 임시 폴더에 풀고 끝나면 지웁니다(중립적인 이름으로 배치).
Source: "dist\macro_pro_app\vgamepad\win\vigem\install\x64\ViGEmBusSetup_x64.msi"; DestDir: "{tmp}"; DestName: "runtime_x64.msi"; Flags: deleteafterinstall
...
Type: files; Name: "{commondesktop}\mAuto Pro 갱신.lnk"
...
[Icons]
Name: "{group}\mAuto Pro"; Filename: "{app}\launcher_pro.exe"
Name: "{commondesktop}\mAuto Pro"; Filename: "{app}\launcher_pro.exe"
...
Filename: "{app}\launcher_pro.exe"; Parameters: "/postupdate"; Flags: nowait; Check: ShouldRunPostInstallLauncher
